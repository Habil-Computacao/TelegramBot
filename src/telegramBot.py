...
_token = '1401583441:AAEPwUV3RzQMAtGBsu_0gkju09Nl04YxKkk'
# Read messages
_url_base = f'https://api.telegram.org/bot{_token}/getUpdates'
# Print results
...
class TelegramBot:
    ...
    def criar_resposta(self, mensagem, eh_primeira_mensagem):
        if eh_primeira_mensagem is True or mensagem in ('menu', 'Menu'):
            return f'''Olá bem vindo a nossa lanchonete Digite o número do hamburguer gostaria de pedir:{os.linesep}1 
- Queijo MAX{os.linesep}2 - Duplo Burguer Bacon{os.linesep}3 - Triple XXX '''
        if mensagem == '1':
